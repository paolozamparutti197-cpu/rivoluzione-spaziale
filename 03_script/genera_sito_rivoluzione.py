...
<section id="flight-13">
  <div class="inner">
    ...
    <article class="panel">
      <h3>Secondo volo V3: successo ship-side, recovery S40 sul semi-sommergibile</h3>
      <p>Flight 13 ha impiegato <strong>Booster 20</strong> e <strong>Ship 40</strong> da Pad 2, con decollo alle <strong>22:51 UTC del 24 luglio 2026</strong> (25 luglio 00:51 CEST). Dopo l'abort a T-0 del 16 luglio e lo scrub meteo del 23, il profilo suborbitale e andato in porto con esito integrato <strong>successo/parziale</strong>: 20 Starlink V3 dispiegati, relight Raptor in spazio, Ship integra dopo soft splashdown; booster con landing burn incompleto e hard splashdown nel Golfo. Al <strong>18 agosto</strong> SpaceX guida lo scafo da 52&nbsp;m al largo di <strong>Christmas Island</strong>. Il <strong>27 agosto</strong> chiude il recovery oceanico: ispezione TPS, campioni di heat shield, carico su nave semi-sommergibile. Viaggio di mesi verso Starbase. Non e riuso.</p>
      <div class="starship-status-grid">
        ...
        <div class="starship-status"><b>18 agosto · Christmas Island</b><span>S40 al largo dell'isola dopo 24 giorni di traino (scheda Flight 13).</span></div>
        <div class="starship-status"><b>27 agosto · semi-sommergibile</b><span>Ispezione TPS fatta; S40 caricata su nave verso Starbase, viaggio di mesi.</span></div>
